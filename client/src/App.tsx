...
export function ExpenseProjection() {
  ...
  // Project next 6 months based on fixed expenses
  const projectFutureExpenses = () => {
    ...
    for (let i = 0; i < 6; i++) {
      ...
      // Add installment expenses that fall in this month
      expenses.forEach((exp) => {
        if (
          ...
          // Check if this installment would fall in the projected month
          if (
